...
* One of your first tasks is to provide staff with read-level access to your repository where this file is stored.
  * Add the unit teaching staff account for bitbucket.
...
## Notes
* Do not share teaching materials provided in this unit. That include lecture notes, sample code, spike documents, as well as your own work that could be inappropriately used by someone else.
